...
Sidebar.prototype.init = function()
{
	...
	this.addCorePalette(dir, true);
	this.addGeneralPalette(true);
	this.addMiscPalette(false);
	this.addAdvancedPalette(false);
	this.addStencilPalette('workflow', 'Workflow', dir + '/workflow.xml',
 ...
 */
Sidebar.prototype.addCorePalette = function(dir, expand)
{
	...
	var fns =
		[
			this.createVertexTemplateEntry('whiteSpace=wrap;html=1;', 120, 60, 'Activity', 'Activity', null, null, 'activity'),
			this.addEntry('start begin', function()
			{
				var cell = new mxCell('Begin', new mxGeometry(0, 0, 120, 50), 'html=1;shape=capsule;whiteSpace=wrap;rounded=1;fillColor=#DBFFDE;');
				cell.vertex = true;
				return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Begin');
			}),
			this.addEntry('stop end', function()
			{
				var cell = new mxCell('End', new mxGeometry(0, 0, 120, 50), 'html=1;shape=capsule;whiteSpace=wrap;rounded=1;fillColor=#FFDBDE;');
				cell.vertex = true;
				return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'End');
			}),
	...
	this.addPaletteFunctions('wf', 'Workflow ' + mxResources.get('general'), expand, fns);
};
